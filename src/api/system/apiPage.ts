 ...
 * 新增可授权的接口ID
 */
export const addOperations_api = (data: object) =>
  request.patch(`/application/operations/_batch`, data);
/**
 * 删除可授权的接口ID
 */
export const delOperations_api = (data: object) =>
  request.remove(`/application/operations/_batch`, {}, { data });
 ...
 * 赋权-选中/取消选中api
 */
export const updateOperations_api = (id: string, data: object) =>
  request.post(`/application/${id}/grant`, data);
