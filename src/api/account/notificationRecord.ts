...
// 修改记录状态
export const changeStatus_api = (type: '_read' | '_unread', data: string[]): any =>
  request.post(`/notifications/${type}`, data);

//查看工作流通知详情
export const getWorkflowNotice = (data: any) =>
  request.post('/process/runtime/processes/_query/no-paging', data);
