...
// 第三方账号解绑
export const unBind_api = (appId: string) =>
  request.post(`/application/sso/${appId}/unbind/me`, []);
/**
 * 校验字段合法性
 * @param type 类型
 * @param name 值
 ...
 * @param password 旧密码
 */
export const checkOldPassword_api = (password: string) =>
  request.post(`/user/me/password/_validate`, password, {
    headers: {
      'Content-Type': 'text/plain',
    },
  });
