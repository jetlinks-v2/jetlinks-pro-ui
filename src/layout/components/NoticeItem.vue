  ...
  <div class="list-items">
    ...
    >
      <div class="list-item-left">
        <div class="header">
          <div class="title">
            ...
            <span :style="{ color: state === 'unread' ? 'red' : '#AAAAAA' }">
              {{ state === 'unread' ? '未读' : '已读' }}
            </span>
          </div>
          <div class="time">
            {{ dayjs(props.data?.notifyTime).format('YYYY-MM-DD HH:mm:ss') }}
          </div>
        </div>
      ...
      <div class="list-item-right">
        ...
        <a-button class="btn" v-if="state === 'unread'" @click.stop="read('_read')">
          标为已读
        </a-button>
